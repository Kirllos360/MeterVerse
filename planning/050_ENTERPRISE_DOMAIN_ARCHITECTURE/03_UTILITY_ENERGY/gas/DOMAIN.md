...
**File:** `03_UTILITY_ENERGY/gas/DOMAIN.md`
**Domain ID:** MV-DOM-023
**Priority:** P1 | **Status:** Draft

---

## Business Purpose
Manage gas metering including consumption, pressure monitoring, and safety compliance.

## Business Owner
Utility Director

## Enterprise Scope
Natural gas metering for residential and commercial customers.

## Capabilities
| Consumption | BTU/m³ consumption |
| Safety | Pressure and leak monitoring |
