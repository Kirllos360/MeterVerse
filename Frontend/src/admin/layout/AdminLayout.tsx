...
const ALL_NAV_GROUPS = [
  ...
  { label: "System", items: [
    ...
    { id: "accounting", label: "Accounting", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7" },
    ...
    { id: "api-management", label: "API Mgmt", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
  ]},
