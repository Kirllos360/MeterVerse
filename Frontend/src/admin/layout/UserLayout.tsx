...
// removed from user navigation (user operates, admin governs).
...
export default function SystemLayout({ children, theme = "green", title = "Administration" }: SystemLayoutProps) {
  const isGreen = true
