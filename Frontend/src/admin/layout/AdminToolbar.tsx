...
export function AdminToolbar({ activePage, viewMode = "list", onViewModeChange, onToggleInspector }: AdminToolbarProps) {
  ...
  return (
    <div className="flex items-center h-11 px-4 gap-2" style={{ backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", backgroundColor: "rgba(10,10,10,0.7)", borderBottom: "1px solid rgba(255,255,255,0.05)", zIndex: 10 }}>
      
      {/* Logo */}
      <div className="flex items-center gap-2.5">
        <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-bold shrink-0" style={{ backgroundColor: "var(--admin-accent)", color: "white", boxShadow: "0 0 10px rgba(220,38,38,0.3)" }}>MV</div>
      ...
      {/* Search */}
      <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg flex-1 max-w-[200px]" style={{ backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        <input placeholder="Search admin..." className="w-full bg-transparent outline-none text-xs" style={{ color: "rgba(255,255,255,0.6)" }} />
      </div>
...
export function AdminStatusBar({ inspectorOpen, onToggleInspector }: AdminStatusBarProps) {
  ...
  return (
    <div className="flex items-center h-7 px-4 gap-2 text-[11px]" style={{ backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", backgroundColor: "rgba(10,10,10,0.7)", borderTop: "1px solid rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.4)" }}>
