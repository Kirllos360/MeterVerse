        ...
        {connections.map((conn, idx) => (
          <div key={conn.id} className="p-4 rounded-lg space-y-3" style={{ backgroundColor: "var(--surface-base)", border: "1px solid var(--border-default)" }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><label htmlFor="lbl-project-name" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>Project Name *</label>
                <input id="lbl-project-name" value={conn.projectName} onChange={e => updateConnection(conn.id, "projectName", e.target.value)} placeholder="Palm Hills October" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
              <div><label htmlFor="lbl-ip-address" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>IP Address *</label>
                <input id="lbl-ip-address" value={conn.ip} onChange={e => updateConnection(conn.id, "ip", e.target.value)} placeholder="192.168.1.100" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
              <div><label htmlFor="lbl-port" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>Port</label>
                <input id="lbl-port" value={conn.port} onChange={e => updateConnection(conn.id, "port", e.target.value)} placeholder="8080" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
              <div><label htmlFor="lbl-api-key" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>API Key *</label>
                <input id="lbl-api-key" type="password" value={conn.apiKey} onChange={e => updateConnection(conn.id, "apiKey", e.target.value)} placeholder="symbiot-api-key" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
              <div><label htmlFor="lbl-username" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>Username</label>
                <input id="lbl-username" value={conn.username} onChange={e => updateConnection(conn.id, "username", e.target.value)} placeholder="admin" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
              <div><label htmlFor="lbl-password" className="block text-[10px] font-medium mb-1" style={{ color: "var(--text-secondary)" }}>Password</label>
                <input id="lbl-password" type="password" value={conn.password || ""} onChange={e => updateConnection(conn.id, "password", e.target.value)} placeholder="password" className="w-full px-2.5 py-1.5 rounded text-xs border outline-none" style={{ borderColor: "var(--border-default)", backgroundColor: "var(--surface-raised)", color: "var(--text-primary)" }} /></div>
            </div>
