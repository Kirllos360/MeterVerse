...
const entityConfigs: Record<string, EntityConfig> = {
  ...
  "sim-cards": { endpoint: "/api/sim", listKey: "sims", columns: [{ id: "simNumber", label: "SIM Number" }, { id: "iccid", label: "ICCID" }, { id: "status", label: "Status" }], fields: [{ name: "simNumber", label: "SIM Number", type: "text", required: true }, { name: "iccid", label: "ICCID", type: "text", required: true }, { name: "operator", label: "Operator", type: "text" }] },
              ...
              >
                ...
                <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: "var(--border-default)" }}>
                  ...
                  <div className="relative">
                    ...
                    <div id={`menu-${i}`} className="hidden absolute right-0 bottom-full mb-1 w-36 rounded-xl z-50 overflow-hidden" role="menu" tabIndex={-1} style={{ backgroundColor: "var(--surface-raised)", boxShadow: "var(--shadow-md)" }} onClick={(e) => e.stopPropagation()} onKeyDown={(e) => e.stopPropagation()}>
