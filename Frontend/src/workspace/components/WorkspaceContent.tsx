              ...
              >
                ...
                <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: "var(--border-default)" }}>
                  ...
                  <div className="relative">
                    ...
                    <div id={`menu-${i}`} className="hidden absolute right-0 bottom-full mb-1 w-36 rounded-xl z-50 overflow-hidden" role="menu" tabIndex={-1} style={{ backgroundColor: "var(--surface-raised)", boxShadow: "var(--shadow-md)" }} onClick={(e) => e.stopPropagation()}>
