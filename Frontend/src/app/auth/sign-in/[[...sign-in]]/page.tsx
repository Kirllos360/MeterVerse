...
export const metadata: Metadata = {
  title: "Sign In - MeterVerse OS",
  description: "Sign in to MeterVerse OS",
}
    ...
    <div className="flex min-h-screen items-center justify-center p-4" style={{ backgroundColor: "var(--surface-base)" }}>
      <div className="w-full max-w-sm p-6 rounded-xl border" style={{ backgroundColor: "var(--surface-raised)", borderColor: "var(--border-default)" }}>
        <div className="text-center mb-6">
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>Sign in to MeterVerse OS</p>
        </div>
        <div className="space-y-3">
          ...
          <button className="w-full py-2 rounded-lg text-sm font-medium text-white" style={{ backgroundColor: "var(--brand-primary)" }}>Sign In</button>
        </div>
      </div>
    </div>
  )
