...
export async function GET(request: NextRequest) { return handleRequest(request, "GET", "/admin/settings") }
export async function PUT(request: NextRequest) { return handleRequest(request, "PUT", "/admin/settings") }
