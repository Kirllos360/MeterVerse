  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          {n:"Email Notifications",s:"Active",c:"#22C55E",d:"Transactional and system emails"},
          {n:"Push Notifications",s:"Coming Soon",c:"#F59E0B",d:"Browser and mobile push"},
          {n:"SMS Alerts",s:"Not Configured",c:"#F59E0B",d:"Configure SMS gateway first"},
          {n:"Slack Webhooks",s:"Not Configured",c:"rgba(255,255,255,0.3)",d:"Slack integration coming soon"},
          {n:"Webhook Deliveries",s:"Active",c:"#22C55E",d:"Outgoing webhook notifications"},
          {n:"In-App Alerts",s:"Active",c:"#22C55E",d:"Dashboard notification center"},
        ].map(i => (
