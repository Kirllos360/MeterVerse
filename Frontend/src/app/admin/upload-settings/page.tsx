      ...
      <div className="rounded-2xl border p-6" style={{ backgroundColor: "var(--surface-raised)", borderColor: "var(--border-default)" }}>
        ...
        {tab === 1 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-lg space-y-4">
            <div><label htmlFor="lbl-max-upload-size" className="text-xs font-semibold block mb-1" style={{ color: "var(--text-secondary)" }}>Max Upload Size</label><select id="lbl-max-upload-size" value={maxSize} onChange={e => setMaxSize(e.target.value)} className="w-full rounded-xl border px-3 py-2 text-xs outline-none" style={{ backgroundColor: "var(--surface-topbar)", borderColor: "var(--border-default)", color: "var(--text-primary)" }}><option>50 MB</option><option>100 MB</option><option>200 MB</option></select></div>
            <div><label htmlFor="lbl-allowed-formats" className="text-xs font-semibold block mb-1" style={{ color: "var(--text-secondary)" }}>Allowed Formats</label><div className="flex gap-2"><label className="flex items-center gap-1 text-xs" style={{ color: "var(--text-secondary)" }}><input  id="lbl-allowed-formats" type="checkbox" defaultChecked /> .csv</label><label className="flex items-center gap-1 text-xs" style={{ color: "var(--text-secondary)" }}><input type="checkbox" defaultChecked /> .xlsx</label><label className="flex items-center gap-1 text-xs" style={{ color: "var(--text-secondary)" }}><input type="checkbox" defaultChecked /> .xml</label></div></div>
