  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          {n:"SMTP Server",s:"Not configured",c:"#EF4444",d:"Configure email sending"},
          {n:"SMS Gateway",s:"Not configured",c:"#EF4444",d:"Configure SMS notifications"},
          {n:"OAuth Providers",s:"Coming Soon",c:"rgba(255,255,255,0.3)",d:"Google, Microsoft, GitHub SSO"},
          {n:"Webhook System",s:"Active",c:"#DC2626",d:"Outgoing webhook endpoints"},
          {n:"API Access",s:"Active",c:"#DC2626",d:"REST API with key auth"},
          {n:"File Storage",s:"Local",c:"#DC2626",d:"Local filesystem storage"},
        ].map(i => (
