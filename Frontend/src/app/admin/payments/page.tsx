    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold" style={{ color: "var(--text-primary)" }}>Payments Dashboard</h1>
            <p className="text-sm" style={{ color: "var(--text-secondary)" }}>Transaction & revenue analytics</p>
          </div>
