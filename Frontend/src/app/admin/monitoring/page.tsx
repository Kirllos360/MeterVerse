  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 rounded-xl border" style={{ backgroundColor: "#0A0A0A", borderColor: "#1A1A1A" }}>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={api.route} className="py-2 text-xs" style={{ borderBottom: "1px solid #1A1A1A" }}>
        ...
        <div className="p-4 rounded-xl border" style={{ backgroundColor: "#0A0A0A", borderColor: "#1A1A1A" }}>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={j.job} className="py-2 text-xs" style={{ borderBottom: "1px solid #1A1A1A" }}>
                ...
                <div className="flex gap-3" style={{ color: "rgba(255,255,255,0.4)" }}>
                  ...
                  <span style={{ color: j.failed > 0 ? "#EF4444" : "inherit" }}>Failed: {j.failed}</span>
                </div>
              </div>
            ))}
          </div>
