      ...
      <div className="grid grid-cols-3 gap-3">
        {["October","New Cairo","SODIC","Sheikh Zayed","North Coast","Red Sea"].map(a => (
          <div key={a} className="rounded-xl border p-4" style={{backgroundColor:"var(--admin-surface)",borderColor:"var(--admin-border)"}}>
            <div className="flex items-center justify-between"><span className="text-sm font-medium text-white">{a}</span><span className="text-[10px] px-2 py-0.5 rounded-full" style={{backgroundColor:"rgba(34,197,94,0.1)",color:"#22C55E"}}>active</span></div>
