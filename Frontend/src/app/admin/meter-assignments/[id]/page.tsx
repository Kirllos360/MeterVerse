  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2"><StatusBadge status={assignment.status} /><Button variant="outline" onClick={() => router.push("/admin/meter-assignments")}>Back to list</Button></div>
      </div>
