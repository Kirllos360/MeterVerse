    ...
    <PageContainer pageTitle="Billing" pageDescription="Subscription and billing management">
      <div className="flex items-center justify-center h-64 rounded-xl border-2 border-dashed" style={{ borderColor: "var(--border-default)" }}>
        <div className="text-center">
          <p className="text-sm font-medium" style={{ color: "var(--text-secondary)" }}>Billing Management</p>
          <p className="text-xs mt-1" style={{ color: "var(--text-tertiary)" }}>Billing settings coming soon</p>
        </div>
      </div>
    </PageContainer>
  )
