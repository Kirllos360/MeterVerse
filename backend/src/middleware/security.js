...
const ROLE_PERMISSIONS = {
  super_admin: null,
  admin: ["customers.*", "meters.*", "readings.*", "invoices.*", "payments.*", "notifications.*", "meter_assignments.*", "admin.*", "ai.*", "business.*", "monitor.*", "reports.*", "services.*", "preferences.*", "governance.*", "tenant.*", "workflow.*", "accounting.events.*", "accounting.mappings.*", "revenue.*", "tariffs.*", "collections.*", "reporting.financial.*"],
